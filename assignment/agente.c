...
int main(int argc, char **argv) {
  ...
  while(1) {
    ...
    int tamanho_buffer_jogadas_filosofo = 0;
    int tamanho_buffer_jogadas_bola = 0;
    int tamanho_jogadas_filosofo = 0; 
    int tamanho_jogadas_bola = 0;

    // cria nossas jogadas possíveis
    printf("cria nossas jogadas possíveis\n");
    ...
    JogadaFilosofo_t *menor_utilidade_jogada = malloc(sizeof(JogadaFilosofo_t));
    ...
    for(int i = 0; i < tamanho_jogadas_filosofo; ++i) {
      ...
      if(menor_utilidade > menor_utilidade_atual) {
        ...
        menor_utilidade_jogada = jogadas_filosofo[i];
      }
    }
    
    // itera sobre nossas jogadas possíveis
    ...
    for(int i = 0; i < tamanho_jogadas_bola; ++i) {
      ...
      if(menor_utilidade > menor_utilidade_atual) {
        menor_utilidade = menor_utilidade_atual;
        menor_utilidade_jogada = jogadas_bola[i];
      }
      // escolhe a jogada com menor utilidade entre as nossas
